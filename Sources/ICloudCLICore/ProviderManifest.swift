...
public enum ProviderRegistry {
    ...
    public static let providers: [ProviderDescriptor] = [
        ...
        provider("drive", "iCloud Drive", .stable, .filesystem, .moderate, ["drive containers", "drive errors", "drive list", "drive recents", "drive shared", "drive status"], ["bounded-crawl", "containers", "inventory", "recents", "sharing", "sync-status"], true),
