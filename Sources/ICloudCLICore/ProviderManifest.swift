...
public enum ProviderRegistry {
    ...
    public static let providers: [ProviderDescriptor] = [
        provider("account", "iCloud Account", .stable, .preferences, .low, ["account status"], ["archive-metadata", "status"], true),
        provider("backup", "iCloud Backup", .stable, .preferences, .moderate, ["backup status"], ["archive-metadata", "status"], true),
        ...
        provider("devices", "iCloud Devices", .stable, .preferences, .moderate, ["devices list"], ["archive-metadata", "inventory", "status"], true),
        provider("drive", "iCloud Drive", .stable, .filesystem, .moderate, ["drive containers", "drive errors", "drive list", "drive recents", "drive shared", "drive status"], ["archive-metadata", "bounded-crawl", "containers", "inventory", "recents", "sharing", "sync-status"], true),
        ...
        provider("focus", "Focus", .stable, .preferences, .moderate, ["focus status"], ["archive-metadata", "status"], true),
        provider("freeform", "Freeform", .beta, .sqlite, .moderate, ["freeform list"], ["inventory", "date-filtering"]),
        provider("handoff", "Handoff", .beta, .filesystem, .moderate, ["handoff list"], ["activity", "archive-metadata", "recents"], true),
        ...
        provider("storage", "iCloud Storage", .stable, .preferences, .low, ["storage status"], ["archive-metadata", "quota", "status"], true),
        provider("tags", "Finder Tags", .beta, .mixed, .moderate, ["tags items", "tags list"], ["bounded-crawl", "inventory", "search", "tags"]),
